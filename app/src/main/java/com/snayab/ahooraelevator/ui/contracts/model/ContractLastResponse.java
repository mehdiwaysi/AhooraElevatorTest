...
public class ContractLastResponse {
    @SerializedName("status")
    private Integer status;
    @SerializedName("last_contract")
    private LastContract lastContract;
    ...
    public LastContract getLastContract() {
        return lastContract;
    }

    public void setLastContract(LastContract lastContract) {
